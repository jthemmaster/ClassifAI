...
def download_data(
    url: str, destination: str, remove_source: bool = True
) -> Path:
    """
    ...
    Args:
        ...
        remove_source: bool: Whether to remove the source file after
        downloading
    ...
    Example usage:
    download_data("https://github.com/mrdbourke/pytorch-deep-learning/raw/main
    data/pizza_steak_sushi.zip", destination="pizza_steak_sushi.zip")
    """
